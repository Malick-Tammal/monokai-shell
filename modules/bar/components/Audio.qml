    ...
    Rectangle {
        ...
        Item {
            ...
            Rectangle {
                ...
                color: audioMouseArea.containsMouse ? Style.featureHover : Style.feature
        ...
        Row {
            ...
            Symbols {
                ...
                color: Style.textOnFeature
            }

            Sliding {
                text: Math.round(Audio.volume * 100)
                textColor: Style.textOnFeature
        ...
        Rectangle {
            anchors.fill: parent
            color: "transparent"
            border.color: Style.featureBorder
            border.width: 1
            radius: con.radius
            z: 2
        }
